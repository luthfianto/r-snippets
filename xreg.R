...
# Create a holiday xreg matrix from a `holiday_yday` list
get_holiday_xreg <- function(holiday_yday) {
  simplify2array( Map(get_holiday_vector, holiday_yday) )
  # simplify2array return a matrix from Map's list of list
}
